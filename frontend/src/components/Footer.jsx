...
const Footer = () => (
  ...
  <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 bg-black">
    <div className="w-full flex sm:flex-row flex-col justify-between items-center my-4">
      <div className="flex flex-[0.5] justify-center items-center max-w-full max-h-full">
        <img src={logo} alt="logo" className="w-[500px] h-auto  filter grayscale hover:filter-none transition duration-300" />
      </div>
